...
/*! \file dirtree.hpp
  ...
  value -1 (used to denote a bad inode).
...
public:
  ...
  bool is_orderable() const { return dirtree_is_orderable(d); }
  ...
  {
    qstring out;
    dirtree_get_abspath_by_cursor(&out, d, cursor, name_flags);
    return out;
  }
  ...
  bool is_dir_ordered(diridx_t diridx) const { return dirtree_is_dir_ordered(d, diridx); }
  ...
  /// \return \ref dterr_t error code
  /// \note this function may disable natural ordering of the parent folder
  /// \sa set_natural_order()
