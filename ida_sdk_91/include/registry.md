...
// Unix systems use a file in the user directory (usually $HOME/.idapro/ida.reg)
#if !defined(LOCAL_REGISTRY) && !defined(__NT__)
#  define LOCAL_REGISTRY
#endif
//#define LOCAL_REGISTRY // for testing local registry on windows, uncomment

//---------------------------------------------------------------------------
// Each application has its own registry file
#ifdef LOCAL_REGISTRY
...
idaman THREAD_SAFE bool ida_export set_registry_name(const char *name);
