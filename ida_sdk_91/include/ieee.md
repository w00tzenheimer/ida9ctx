...
///@{
const uint32
  MAXEXP_FLOAT  = 0x80,   ///< maximum exponent for 32-bit float
  MAXEXP_DOUBLE = 0x400,  ///< maximum exponent for 64-bit double
  MAXEXP_LNGDBL = 0x4000; ///< maximum exponent for 80-bit long double
///@}
